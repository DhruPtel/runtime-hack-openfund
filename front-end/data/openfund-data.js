...
window.OPENFUND_EXPORT = {
 ...
 "empty": {
  ...
  "overview": {
   ...
   "latest": {
    "approved": 0,
    "headline": "No cycle has run in this session.",
    "summary": "Press “Run a cycle” to start one. It takes about four minutes and spends about $1.20 of inference.",
    "vetoed": 0
   },
   "nav": null,
   ...
   "provenance": {
    ...
    "signatureStatus": "Nothing signed yet",
    "snapshotHash": null,
    "timestamp": "—"
   },
   "subtitle": "Nothing decided yet. Run a cycle to watch four analysts read one frozen snapshot and a risk agent rule on what they propose.",
  ...
  "swarm": {
   "agents": [
    {
     ...
     "latency": null,
     "paragraphs": [
      "This seat has not been asked in this session. Run a cycle and its report will appear here, in full, exactly as it was written."
     ],
     "perspective": "Price Trend: waiting",
     "primaryCall": {
      "asset": "—",
      "call": "waiting"
     },
    ...
    },
    {
     ...
     "perspective": "Cross Asset Macro: waiting",
     "primaryCall": {
      "asset": "—",
      "call": "waiting"
     },
    ...
    },
    {
     ...
     "perspective": "Execution Quality: waiting",
     "primaryCall": {
      "asset": "—",
      "call": "waiting"
     },
    ...
    },
    {
     ...
     "perspective": "Price Integrity: waiting",
     "primaryCall": {
      "asset": "—",
      "call": "waiting"
     },
   ...
   "parallelTime": null,
   "quorum": "no seat has reported in this session",
   "reportCost": null,
   "signedReports": 0,
   "snapshot": {
    "block": null,
 ...
 "generated_at": "2026-09-20T02:42:15+00:00",
 "overview": {
